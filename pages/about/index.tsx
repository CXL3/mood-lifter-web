      ...
      <main className="bg-gradient-to-br from-blue-400 to-cyan-300 min-h-screen flex flex-col items-center justify-center p-5 text-white">
        ...
        <div className="text-center flex flex-col items-center justify-center w-full pt-24 md:pt-0">
          ...
          <p className="text-lg md:text-xl font-medium mb-6 max-w-4xl">
            In a world that moves fast, it&apos;s easy to lose sight of our emotional
            health. Our mission is to provide everyone with accessible,
            immediate tools to calm down, lift moods, and offer a guiding light
            out of moments of darkness. We believe in the power of simple acts &mdash;
            like breathing exercises, mindful meditation, or even a quick nap &mdash;
            to transform your day.
          </p>
          <p className="text-lg md:text-xl font-medium mb-6 max-w-4xl">
            Whether you&apos;re experiencing stress, anxiety, or feeling overwhelmed,
            our platform is here to support your journey toward emotional
            balance. From practical tips to engaging activities, we offer a
            variety of resources tailored to foster mental wellness and
            resilience.
          </p>
          <p className="text-lg md:text-xl font-medium mb-6 max-w-4xl">
            Join us in embracing a healthier, more mindful approach to managing
            emotions and navigating life&apos;s challenges. Your journey to emotional
